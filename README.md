...
there appears to be a bit of a community kerfuffle between Hadley (AKA
The Grand Master), and the folks at `devtools`…per
...
you will need to install `knitr`, `kableExtra` to get R to build the
markdown vignette.
