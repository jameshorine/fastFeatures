...
3. (turns out I was wrong about (2), and there appears to be a bit of a community kerfuffle between Hadley (AKA The Grand Master), and the folks at `devtools`)
...
1. The "mixing" properties of this algorithm have not been explored at this time. Users should use their judgement in parameter settings. If you have many predictors, you may not adequately explore the (conditional) Variable Inclusion Probability distribution. 

1. Contrary to [1], [2] (below), `l1_lambda` is NOT optimized at every iteration of the algorithm.  
