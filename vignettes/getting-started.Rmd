...
General guidelines are to pre-tune for a *good enough* value of  $\lambda$, and choose a value of `column_proportion` that ensures roughly 10-20x coverage. That is to say we want the quantity 
